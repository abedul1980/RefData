...
-- Table comment
COMMENT ON TABLE tdaapprovalstatus IS '{"label": "Governance approval", "description": "List detailing governance approval status", "schemalastupdated": "06/03/2019", "dataversion": 1}';
-- Column comments
