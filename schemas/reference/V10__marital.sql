...
COMMENT ON COLUMN marital.id IS '{"description": "database unique identity record", "summaryview": "false"}';
COMMENT ON COLUMN marital.code IS '{"description": "Short code", "summaryview": "true"}';
COMMENT ON COLUMN marital.description IS '{"description": "Marital status description", "summaryview": "true"}';
