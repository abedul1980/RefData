...
CREATE TABLE itemlevel3 (
  ...
  seizure_qty NUMBER NOT NULL,
  ien_qty NUMBER NOT NULL,
  validfrom TIMESTAMP WITH TIME ZONE,
  validto TIMESTAMP WITH TIME ZONE
);
...
-- Column comments
COMMENT ON COLUMN itemlevel1.name IS '{"label": "Identifier", "description": "Level 1 Item name", "summaryview": "false"}';
COMMENT ON COLUMN itemlevel1.description IS '{"label": "Description of Level 1 Item name", "description": "Description of Item", "summaryview": "true"}';
...
-- Column comments
COMMENT ON COLUMN itemlevel3.name IS '{"label": "Identifier", "description": "Level 3 Item name", "summaryview": "false"}';
