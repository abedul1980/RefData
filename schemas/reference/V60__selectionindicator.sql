...
-- Table comment
COMMENT ON TABLE selectionindicator IS '{"label": "Selection Indicator", "description": "A list of reasons for conducting a search on a particular vehical.", "schemalastupdated": "15/07/2019", "dataversion": 1}';
-- Column comments
...
COMMENT ON COLUMN selectionindicator.indicator IS '{"description": "Reason for selecting vehical for search.", "summaryview": "true"}';
