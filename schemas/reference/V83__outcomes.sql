...
-- Table comment
COMMENT ON TABLE outcomes IS '{"label": "outcomes", "description": "The outcome of an event.", "schemalastupdated": "28/08/2019", "dataversion": 1}';
-- Column comments
...
COMMENT ON COLUMN outcomes.counterterrorism IS '{"label": "Counter Terrorism", "description": "Is this outcome related to CT?", "summaryview": "false"}';
