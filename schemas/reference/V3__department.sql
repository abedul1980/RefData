...
COMMENT ON COLUMN department.name IS '{"description": "The name of the department.", "summaryview": "true"}';
COMMENT ON COLUMN department.code IS '{"description": "The code associated with the department.", "summaryview": "true"}';
