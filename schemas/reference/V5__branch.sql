...
-- Table comment
COMMENT ON TABLE branch IS '{"label": "Branch / Region names", "description": "Name of branches or regions associated with directorate", "schemalastupdated": "06/03/2019", "dataversion": 1}';
-- Column comments
