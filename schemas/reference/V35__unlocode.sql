...
COMMENT ON COLUMN unlocode.seaport IS '{"label": "Sea port", "description": "Is a sea port?", "summaryview": "false"}';
COMMENT ON COLUMN unlocode.railterminal IS '{"label": "Rail terminal", "description": "Is a rail terminal?", "summaryview": "false"}';
COMMENT ON COLUMN unlocode.airport IS '{"label": "Airport", "description": "Is an airport?", "summaryview": "false"}';
COMMENT ON COLUMN unlocode.postexchange IS '{"label": "Post exchanget", "description": "Is a postal exchange?", "summaryview": "false"}';
