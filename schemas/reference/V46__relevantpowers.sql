CREATE TABLE relevantpowers (
  ...
  url VARCHAR(100),
  searchofperson BOOLEAN NOT NULL,
...
COMMENT ON COLUMN relevantpowers.searchofperson IS '{"label": "sop", "description": "Valid power for search of person.", "summaryview": "false"}';
