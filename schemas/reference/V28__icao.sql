...
COMMENT ON COLUMN icao.name IS '{"label": "Name", "description": "The ICAO site name.", "summaryview": "true"}';
COMMENT ON COLUMN icao.iata IS '{"label": "IATA", "description": "The IATA code.", "summaryview": "true"}';
COMMENT ON COLUMN icao.municipality IS '{"label": "City", "description": "Municipality/region", "summaryview": "true", "aliases": ["city", "region"]}';
COMMENT ON COLUMN icao.icao IS '{"label": "ICAO code", "description": "The ICAO code.", "summaryview": "true"}';
