...
COMMENT ON COLUMN targetmode.ca IS '{"label": "Cash enabled", "description": "Valid for IEN", "summaryview": "true"}';
COMMENT ON COLUMN targetmode.ct IS '{"label": "Counter Terrorism enabled", "description": "Valid for IEN", "summaryview": "true"}';
