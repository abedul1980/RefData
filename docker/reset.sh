...
export REFDB_OWNERPASSWORD=${FLYWAY_PLACEHOLDERS_REFERENCE_OWNER_PASSWORD:-mysecretpassword}
...
export REFDB_URL="postgresql://${GOVERNANCE_OWNERNAME}:${REFDB_OWNERPASSWORD}@${POSTGRES_SERVER}:${POSTGRES_PORT}/${POSTGRES_DB}${POSTGRES_OPTIONS}"
